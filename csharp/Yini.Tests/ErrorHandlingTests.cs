...
";
        ...
        public void ReflectionBind_WithTypeMismatch_ThrowsException()
        {
            ...
            }, "Binding 'is_active' (a bool) to 'not_a_bool' (a string) should fail.");

            StringAssert.Contains(ex.Message, "Cannot convert YINI value of type String to target type Boolean");
        }

...
namespace Yini.Model
{
    ...
    public class YiniInteger : YiniValue
    {
        ...
        public override YiniValue Clone() => new YiniInteger(Value);
    }
    ...
    public class YiniFloat : YiniValue
    {
        ...
        public override object GetRawValue() => Value;
        public override YiniValue Clone() => new YiniFloat(Value);
    }
    ...
    public class YiniBoolean : YiniValue
    {
        ...
        public override object GetRawValue() => Value;
        public override YiniValue Clone() => new YiniBoolean(Value);
    ...
    public class YiniString : YiniValue
    {
        ...
        public override object GetRawValue() => Value;
        public override YiniValue Clone() => new YiniString(Value);
